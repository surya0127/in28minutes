...
function showLikeValues()
{
	...
	$.ajax({
		...
		url : "./setopinion.htm",
		dataType : 'json',
		data : {'selctedsub':selsubjects,'opinion':'Y' },
		success : function(data) {
...
function showDislikeValues()
{
	...
	$.ajax({
		...
		url : "./setopinion.htm",
		dataType : 'json',
		data : {'selctedsub':selsubjects,'opinion':'N' },
		success : function(data) {
			if(data.status == 'success')
				alert(' Saved Successfully');
			},		
...
<li ><a href="redirect.htm?id=updateInfo" style="background-color:#adc4ea"><b>Update Info</b></a></li>
...
<div class="back">
		...
		<div align="center">
			<button type="submit" style="padding-left: 50px"
				onclick="showLikeValues()">Like </button>
				<button type="submit" style="padding-left: 50px"
				onclick="showDislikeValues()">Dislike</button>
		</div>
