...
<nav class="navbar navbar-fixed">
  <div class="container-fluid">
   ...
   <li  class="active" style="background-color:#adc4ea"><a href="redirect.htm?id=studentlogin"><b>Home</b></a></li>
...
<img height="500px" width="100%"src="./../images/studentbg.jpg"/>
</div>
<!-- <div class="back" style="margin-top:-13px;margin-bottom:15px"> -->
