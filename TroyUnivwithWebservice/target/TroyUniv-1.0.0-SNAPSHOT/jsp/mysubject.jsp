		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav"
				...
				<li><a href="redirect.htm?id=subjectteach"
					...
					<li><a href="redirect.htm?id=mysubject" style="background-color: #adc4ea" ><b>Issue Mgmt</b></a></li>
	...
	<div class="back">
		...
		<div align="center">
			<button type="submit" style="padding-left: 50px"
				onclick="showSelectedValues()">Assign</button>
		</div>
